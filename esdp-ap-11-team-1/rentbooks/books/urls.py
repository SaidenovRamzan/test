...
urlpatterns = [
    ...
    path(
        "book/<int:pk>/delete_favorite/",
        views.delete_from_favorite,
        name="delete_favorite",
    ),
    path(
        "composition/admin/",
        views.CompositionAdminListView.as_view(),
        name="composition_admin",
    ),
    path(
        "create_book", views.AllInOneView.as_view(), name="create_all_book"
    ),  # создание book
]
